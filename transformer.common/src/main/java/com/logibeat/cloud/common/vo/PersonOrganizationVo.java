...
public class PersonOrganizationVo {
	...
	/*public PersonOrganizationCarVo getPersonOrganizationCarVo() {
		return personOrganizationCarVo;
	}

	public void setPersonOrganizationCarVo(PersonOrganizationCarVo personOrganizationCarVo) {
		this.personOrganizationCarVo = personOrganizationCarVo;
	}*/
